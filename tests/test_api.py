    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                ...
                "https://www.mercadobitcoin.net/api/BTC/day-summary/2022/6/21",
            ),
            (
                "ETH",
                datetime.date(2022, 6, 21),
                "https://www.mercadobitcoin.net/api/ETH/day-summary/2022/6/21",
            ),
            (
                "ETH",
                datetime.date(2022, 4, 21),
                "https://www.mercadobitcoin.net/api/ETH/day-summary/2022/4/21",
            ),
        ],
    )
